...
import com.altaie.notifier.notification.NotificationImage
    ...
    MaterialTheme {
        Column(
            ...
            Button(onClick = {
                ...
                notifier.notify {
                    id = notificationId
                    title = "Title from Notifier"
                    body = "Body message from Notifier"
                    payloadData = mapOf(
                        Notifier.KEY_URL to "https://github.com/altaie/KMPNotifier/",
